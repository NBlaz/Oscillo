...
// PORT , PIN      , Clock              , Source 
  {GPIOA,GPIO_Pin_5,RCC_AHB1Periph_GPIOF,GPIO_PinSource5}, // SCK an PF7
  {GPIOA,GPIO_Pin_7,RCC_AHB1Periph_GPIOF,GPIO_PinSource7}, // MOSI an PF9
  {GPIOA,GPIO_Pin_6,RCC_AHB1Periph_GPIOF,GPIO_PinSource6}, // MISO an PF8
};
...
ErrorStatus UB_SPI5_Init(SPI5_Mode_t mode)
{
  ...
  GPIO_PinAFConfig(SPI5DEV.SCK.PORT, SPI5DEV.SCK.SOURCE, GPIO_AF_SPI1);
  GPIO_PinAFConfig(SPI5DEV.MOSI.PORT, SPI5DEV.MOSI.SOURCE, GPIO_AF_SPI1);
  GPIO_PinAFConfig(SPI5DEV.MISO.PORT, SPI5DEV.MISO.SOURCE, GPIO_AF_SPI1);
